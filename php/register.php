...
$bdd = new PDO('mysql:host=localhost;dbname='.$db_name, $db_user, $db_pass, array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION)) or die('Failed to connect');
...
$req2->execute(array($user, $email, $pass));
    echo "oui";
} else {
    echo "non";
}
